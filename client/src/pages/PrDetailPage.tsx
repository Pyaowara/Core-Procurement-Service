...
import { SentIcon, Delete02Icon, ShoppingCart02Icon } from "@hugeicons/core-free-icons";
...
export default function PrDetailPage() {
    ...
    const canGeneratePO = user && ["PurchaseOfficer", "Admin"].includes(user.role);
    ...
    return (
        <div className="mx-auto max-w-5xl p-6">
            ...
            {/* Generate PO Button for Approved PR */}
            {!pr.IsDeleted && pr.Status === "APPROVED" && canGeneratePO && (
                <div className="mt-6 flex items-center justify-end gap-2">
                    <Button
